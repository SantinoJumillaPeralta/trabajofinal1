...
int main(){
	...
	if (!playerTexture.loadFromFile("C:/Users/santino/Desktop/meteorito/imagenes/player.png")) {
		cout << "Error loading player texture" << endl;
	}

	if (!enemieTexture.loadFromFile("C:/Users/santino/Desktop/meteorito/imagenes/enemie.png")) {
		cout << "Error loading enemy texture" << endl;
	}

	if (!bulletTexture.loadFromFile("C:/Users/santino/Desktop/meteorito/imagenes/bullet.png")) {
		cout << "Error loading bullet texture" << endl;
	}

	if (!bloodTexture.loadFromFile("C:/Users/santino/Desktop/meteorito/imagenes/blood.png")) {
		cout << "Error loading blood texture" << endl;
	}

	if (!backgroundTexture.loadFromFile("C:/Users/santino/Desktop/meteorito/imagenes/background.png")) {
