...
UISounds::UISounds() {
    music.openFromFile("C:/Users/santino/Desktop/meteorito/sonido/music.ogg");
    music.setLoop(true);
    music.play();
    if (!font.loadFromFile("C:/Users/santino/Desktop/meteorito/fuente/Chernobyl.otf")) {
        cout << "Error al cargar la fuente" << endl;
    }
    if (!soundBuffer.loadFromFile("C:/Users/santino/Desktop/meteorito/sonido/shoot.ogg")) {
